...
PROGOBJS    = main.o websocket.o util.o config.o signalwatcher.o preloadwatcher.o traceengine.o event.o hoytech-cpp/timer.o cmd/base.o cmd/run.o cmd/trace.o cmd/ps.o cmd/ping.o cmd/get.o cmd/tail.o cmd/config.o
...
all: logp logp_preload.so logp_trace_preload.so
...
logp_trace_preload.so: logp_trace_preload.cpp
	$(CXX) $(CXXFLAGS) -shared -fvisibility=hidden -o $@ logp_trace_preload.cpp -ldl
